...
import cbr.TravelRecommender;
import representation.TravelDescription.AccommodationTypes;
import representation.TravelDescription.Seasons;
...
public class QueryDialog extends JDialog {
	...
	private void configureFrame()
	{
		...
		image = new JLabel();
		image.setIcon(new ImageIcon(FileIO.findFile("gui/step1.png")));
